...
class _StoryPageState extends State<StoryPage> {
  void onChoiceSelect (choice) {
    setState(() {
      storyBrain.nextStory(choice);
      isCh2Active = storyBrain.buttonShouldBeVisible();
    });
  }

  bool isCh2Active = true;
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Expanded(
                ...
                // Step 28 - Set the "visible" property of the Visibility Widget to equal the
                // output from the buttonShouldBeVisible() method in the storyBrain.
                child: Visibility(
                  visible: isCh2Active,
                  child: ElevatedButton(
                    ...
                    isCh2Active ? Colors.blue : Colors.grey),
                    child: Text(
...
// Step 24 - Run the app and try to figure out what code you need to add to this file
